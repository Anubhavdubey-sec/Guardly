...
class EmailParserUnitTests(unittest.TestCase):
    ...
    def test_attachment_filename_windows_path_traversal_sanitization(self):
        from services.email_parser import sanitize_filename
        self.assertEqual(sanitize_filename(r"..\..\windows\system32\cmd.exe"), "cmd.exe")
        self.assertEqual(sanitize_filename(r"..\..\evil.sh"), "evil.sh")
